...
type TarStrategy struct {
	// Possible values are: tar.gz (default) or none. If none, the artifact will not be tarballed
	// before saving. Note that if the artifact is a directory, the artifact driver must support
